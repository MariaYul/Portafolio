...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    @Qualifier("autenticationLDAP")
    private AuthenticationProvider archivoAuthenticationProviderLDAP;
    ...
    public void registerGlobalAuthentication(AuthenticationManagerBuilder authentication){
        authentication.authenticationProvider(archivoAuthenticationProviderLDAP);
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
          ...
          //.antMatchers("/solicitud/undecorated/addlistaAdicional.htm").access("hasRole('ROL_SOLICITUD_CONSULTAR')")
          //GENERAL
