...
public interface MonedaRepository extends GenericOperation<Moneda> {
    ...
    /**
     * Consulta dinamicamente los tipos de documento de acuerdo a un rango
     * @param parametro Parámetros de búsqueda
     * @return List<TipoDocumento> Tipos de documento de acuerdo a un rango
     */
